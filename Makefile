...
define Package/luci-app-batmanconf  
  SECTION:=luci
  CATEGORY:=LuCI
...
define Package/luci-app-batmanconf/description
  LuCI Support for bellnett batmanconf
endef
...
define Package/luci-app-batmanconf/postinst
#!/bin/sh
...
define Package/luci-app-batmanconf/install
...
$(eval $(call BuildPackage,luci-app-batmanconf))
